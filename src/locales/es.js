export default {
  content: {
    ...
    'Published outputs and reports': 'Publicaciones e informes',
    'Credentials and recognitions': 'Credenciales y reconocimientos',
    'Public events and presentations': 'Eventos y presentaciones públicas',
    ...
    'Extends Jaime’s analytics profile into international, nonprofit, and volunteer consulting environments where evidence directly supports high-impact decision-making.':
      'Extiende el perfil analítico de Jaime hacia entornos internacionales, de organizaciones sin fines de lucro y consultoría voluntaria donde la evidencia respalda directamente decisiones de alto impacto.',
    'Converted multi-country portfolio data into a usable management asset for executive visibility, comparative analysis, and reporting.':
      'Convirtió datos de portafolio multinacional en un activo de gestión utilizable para visibilidad ejecutiva, análisis comparativo y reporting.',
    'Strengthened advocacy work by turning complex child-rights information into policy-facing evidence, strategic recommendations, and mobilization support.':
      'Fortaleció el trabajo de incidencia al convertir información compleja sobre derechos de la niñez en evidencia útil para políticas, recomendaciones estratégicas y apoyo a la movilización.',
    'Provided continuity in a mission-driven education project by sustaining partner coordination and implementation support during a critical handoff period.':
      'Aportó continuidad a un proyecto educativo con propósito social al sostener la coordinación con aliados y el apoyo a la implementación durante una etapa crítica de transición.',
    'Helped align partnerships, documentation, and data-informed follow-up to improve project continuity and policy relevance in early-childhood work.':
      'Ayudó a alinear alianzas, documentación y seguimiento basado en datos para mejorar la continuidad del proyecto y su relevancia en política pública de primera infancia.',
    'Contributed to high-stakes national policy processes by organizing evidence, drafting technical inputs, and coordinating across institutions and civil society actors.':
      'Contribuyó a procesos nacionales de política pública de alta relevancia mediante la organización de evidencia, elaboración de insumos técnicos y coordinación entre instituciones y actores de la sociedad civil.',
    'Supported collaborative governance processes that improved coordination, accountability, and civic participation in open-government initiatives.':
      'Apoyó procesos de gobernanza colaborativa que mejoraron la coordinación, la rendición de cuentas y la participación cívica en iniciativas de gobierno abierto.',
    'Positioned the institute as a visible local actor in youth policy through programs, alliances, and participatory public-sector leadership.':
      'Posicionó al instituto como un actor local visible en política de juventudes mediante programas, alianzas y liderazgo público participativo.',
    'Improved local protection and welfare delivery by coordinating services, strengthening referrals, and introducing more structured management practices.':
      'Mejoró la protección y la atención social a nivel local mediante coordinación de servicios, fortalecimiento de referencias y prácticas de gestión más estructuradas.',
    'Built an early foundation in institutional processes, coordination, and public-sector execution that later shaped Jaime’s policy and analytics profile.':
      'Construyó una base temprana en procesos institucionales, coordinación y ejecución pública que más adelante dio forma al perfil de política pública y analítica de Jaime.',
    ...
    'I bring a rare combination of public-policy execution, stakeholder coordination, and hands-on analytics for real institutional decisions.':
      'Aporto una combinación poco común de ejecución de política pública, coordinación de actores y analítica aplicada para decisiones institucionales reales.',
    'I can contribute quickly in dashboarding, reporting, data cleaning, indicator design, and evidence synthesis for mission-driven teams.':
      'Puedo aportar rápidamente en dashboarding, reporting, limpieza de datos, diseño de indicadores y síntesis de evidencia para equipos con propósito.',
    'Global portfolio intelligence dashboard': 'Dashboard de inteligencia de portafolio global',
    'BB&R Consulting · Portfolio analytics': 'BB&R Consulting · Analítica de portafolio',
    'Leadership needed a clear view of a complex international project portfolio distributed across countries, years, and thematic areas.':
      'La dirección necesitaba una vista clara de un portafolio internacional complejo de proyectos distribuido por países, años y áreas temáticas.',
    'I built a Power BI dashboard from a cleaned master dataset covering 125 projects, 62 countries, 4 continents, and 19 years of records.':
      'Construí un dashboard en Power BI a partir de una base maestra depurada que cubría 125 proyectos, 62 países, 4 continentes y 19 años de registros.',
    'I turned fragmented reporting into an executive-ready decision tool with filters, KPIs, geographic views, and a standardized taxonomy of 9 strategic areas.':
      'Transformé reportes fragmentados en una herramienta de decisión lista para dirección, con filtros, KPIs, vistas geográficas y una taxonomía estandarizada de 9 áreas estratégicas.',
    ...
    'Campaign and policy teams needed evidence, legislative monitoring, and structured recommendations to support child-rights advocacy.':
      'Los equipos de campañas y política necesitaban evidencia, monitoreo legislativo y recomendaciones estructuradas para respaldar la incidencia en derechos de la niñez.',
    'I analyzed rights-related information, produced technical inputs, monitored legislation, and translated evidence into strategic recommendations and mobilization support.':
      'Analicé información relacionada con derechos, produje insumos técnicos, monitoreé legislación y traduje evidencia en recomendaciones estratégicas y apoyo a la movilización.',
    'I helped connect data, advocacy, and inter-institutional dialogue to strengthen child-protection narratives and public-policy positioning.':
      'Ayudé a conectar datos, incidencia y diálogo interinstitucional para fortalecer narrativas de protección infantil y posicionamiento en política pública.',
    'Policy analysis': 'Análisis de política pública',
    'Research synthesis': 'Síntesis de investigación',
    Reporting: 'Elaboración de reportes',
    'Legislative monitoring': 'Monitoreo legislativo',
    'Stakeholder coordination': 'Coordinación de actores',
    'Youth agenda from regional dialogue to national presentation': 'Agenda de juventudes del diálogo regional a la presentación nacional',
    '#JuventudActuaMX / INE · Civic participation': '#JuventudActuaMX / INE · Participación cívica',
    'Youth perspectives from different regions needed to be organized into a credible agenda for public dialogue and institutional presentation.':
      'Las perspectivas de juventudes de distintas regiones debían organizarse en una agenda creíble para el diálogo público y la presentación institucional.',
    'I supported facilitation, synthesis, and public-engagement work that connected regional inputs, problem analysis, and decision-making spaces.':
      'Apoyé trabajo de facilitación, síntesis y participación pública que conectó insumos regionales, análisis de problemas y espacios de toma de decisión.',
    'I contributed to a youth-led agenda that moved from preparatory working sessions to a national presentation at the INE, strengthening visibility and policy dialogue.':
      'Contribuí a una agenda liderada por juventudes que pasó de sesiones preparatorias de trabajo a una presentación nacional en el INE, fortaleciendo visibilidad y diálogo de política pública.',
